...
import 'package:digitopia_app/widgets/location_picker.dart';
import 'notifictions_screen.dart';
import 'dart:io';
...
class _ShareMealScreenState extends State<ShareMealScreen> {
  ...
  try {
    ...
    await FirebaseFirestore.instance.collection('meals').add({
      ...
      'userName': 'سارة أحمد', // يمكن استبدالها باسم المستخدم الحقيقي
    });

    // إضافة إشعار عند إضافة وجبة جديدة
    NotifictionsScreen.addMealNotification('سارة أحمد', _mealNameController.text);
