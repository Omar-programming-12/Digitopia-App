...
class AboutAppScreen extends StatelessWidget {
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildDivider(),
                  _buildInfoItem(Icons.update, 'آخر تحديث', '15 ديسمبر 2024'),
                  _buildDivider(),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  Text(
                    '© 2024 ديجيتوبيا. جميع الحقوق محفوظة.',
  ...
  void _rateApp() {
    // هنا يمكن إضافة منطق فتح صفحة التقييم في المتجر
  }

  void _shareApp() {
    // هنا يمكن إضافة منطق مشاركة التطبيق
  }

  void _sendFeedback() {
    // هنا يمكن إضافة منطق إرسال الملاحظات
  }

  void _visitWebsite() {
    // هنا يمكن إضافة منطق فتح الموقع الإلكتروني
  }
}